...
namespace EliteAPI.Events
{
    public class MissionCompletedInfo : EventBase
    {
        ...
        internal static MissionCompletedInfo Process(string json, EliteDangerousAPI api)
        {
            return api.Events.InvokeMissionCompletedEvent(JsonConvert.DeserializeObject<MissionCompletedInfo>(json, JsonSettings.Settings));
        }
    }
}