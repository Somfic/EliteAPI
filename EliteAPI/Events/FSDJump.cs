namespace EliteAPI.Events
{
    ...
    public partial class FSDJumpInfo
    {
        public static FSDJumpInfo Process(string json) => EventHandler.InvokeFSDJumpEvent(JsonConvert.DeserializeObject<FSDJumpInfo>(json, EliteAPI.Events.FSDJumpConverter.Settings));
    }
