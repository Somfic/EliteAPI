namespace EliteAPI.Events
{
    ...
    public partial class SelfDestructInfo
    {
        public static SelfDestructInfo Process(string json) => EventHandler.InvokeSelfDestructEvent(JsonConvert.DeserializeObject<SelfDestructInfo>(json, EliteAPI.Events.SelfDestructConverter.Settings));
    }
