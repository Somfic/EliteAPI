namespace EliteAPI.Events
{
    ...
    public partial class SystemsShutdownInfo
    {
        public static SystemsShutdownInfo Process(string json) => EventHandler.InvokeSystemsShutdownEvent(JsonConvert.DeserializeObject<SystemsShutdownInfo>(json, EliteAPI.Events.SystemsShutdownConverter.Settings));
    }
