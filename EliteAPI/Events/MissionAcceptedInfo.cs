...
namespace EliteAPI.Events
{
    public class MissionAcceptedInfo : EventBase
    {
        ...
        internal static MissionAcceptedInfo Process(string json, EliteDangerousAPI api)
        {
            return api.Events.InvokeMissionAcceptedEvent(JsonConvert.DeserializeObject<MissionAcceptedInfo>(json, JsonSettings.Settings));
        }
    }
}