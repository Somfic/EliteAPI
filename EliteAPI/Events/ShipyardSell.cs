namespace EliteAPI.Events
{
    ...
    public partial class ShipyardSellInfo
    {
        public static ShipyardSellInfo Process(string json) => EventHandler.InvokeShipyardSellEvent(JsonConvert.DeserializeObject<ShipyardSellInfo>(json, EliteAPI.Events.ShipyardSellConverter.Settings));
    }
