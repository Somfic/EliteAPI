namespace EliteAPI.Events
{
    ...
    public partial class FighterDestroyedInfo
    {
        public static FighterDestroyedInfo Process(string json) => EventHandler.InvokeFighterDestroyedEvent(JsonConvert.DeserializeObject<FighterDestroyedInfo>(json, EliteAPI.Events.FighterDestroyedConverter.Settings));
    }
