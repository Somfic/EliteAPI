namespace EliteAPI.Events
{
    ...
    public partial class CrewMemberRoleChangeInfo
    {
        public static CrewMemberRoleChangeInfo Process(string json) => EventHandler.InvokeCrewMemberRoleChangeEvent(JsonConvert.DeserializeObject<CrewMemberRoleChangeInfo>(json, EliteAPI.Events.CrewMemberRoleChangeConverter.Settings));
    }
