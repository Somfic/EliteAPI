namespace EliteAPI.Events
{
    ...
    public partial class MarketInfo
    {
        public static MarketInfo Process(string json) => EventHandler.InvokeMarketEvent(JsonConvert.DeserializeObject<MarketInfo>(json, EliteAPI.Events.MarketConverter.Settings));
    }
