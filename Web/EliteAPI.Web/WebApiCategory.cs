...
public abstract class WebApiCategory : IWebApiCategory
{
    ...
    /// <inheritdoc />
    public async Task<WebApiResponse<TResponse>> Execute<TRequest, TResponse>() where TRequest : IWebApiRequest
    {
        try
        {
    ...
    /// <inheritdoc />
    public async Task<WebApiResponse<TResponse>> Execute<TRequest, TResponse>(TRequest? request) where TRequest : IWebApiRequest
    {
        if (request == null)
