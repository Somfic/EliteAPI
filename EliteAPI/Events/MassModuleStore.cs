namespace EliteAPI.Events
{
    ...
    public partial class MassModuleStoreInfo
    {
        public static MassModuleStoreInfo Process(string json) => EventHandler.InvokeMassModuleStoreEvent(JsonConvert.DeserializeObject<MassModuleStoreInfo>(json, EliteAPI.Events.MassModuleStoreConverter.Settings));
    }
