namespace EliteAPI.Events
{
    ...
    public partial class CrewMemberJoinsInfo
    {
        public static CrewMemberJoinsInfo Process(string json) => EventHandler.InvokeCrewMemberJoinsEvent(JsonConvert.DeserializeObject<CrewMemberJoinsInfo>(json, EliteAPI.Events.CrewMemberJoinsConverter.Settings));
    }
