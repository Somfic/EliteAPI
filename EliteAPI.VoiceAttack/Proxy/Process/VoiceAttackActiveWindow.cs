...
namespace EliteAPI.VoiceAttack.Proxy.Process
{
    public class VoiceAttackActiveWindow
    {
        ...
        /// </summary>
        public (int width, int height) WindowSize => new (_proxy.Utility.ActiveWindowWidth(), _proxy.Utility.ActiveWindowHeight());

        /// <summary>
        /// The top left coordinates of the window, relative to the screen
        /// </summary>
        /// <remarks>Top left is 0,0</remarks>
        public (int x, int y) TopLeft => new (_proxy.Utility.ActiveWindowLeft(), _proxy.Utility.ActiveWindowTop());

        /// <summary>
        /// Gets the mouse position relative to the window
        /// </summary>
        /// <remarks>Top left is 0,0</remarks>
        public (int x, int y) MouseRelative => new (_proxy.Utility.MousePositionWindowX(), _proxy.Utility.MousePositionWindowY());

        /// <summary>
        /// Gets the mouse position on the screen
        /// </summary>
        /// <remarks>Top left is 0,0</remarks>
        public (int x, int y) MouseAbsolute => new (_proxy.Utility.MousePositionScreenX(), _proxy.Utility.MousePositionScreenY());
    }
}