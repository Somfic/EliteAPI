...
namespace EliteAPI.Event.Handler
{
    public class EventHandler
    {
        ...
        internal void InvokeStatusInMainMenu(StatusEvent e) => StatusInMainMenu?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusIsRunning;

        internal void InvokeStatusIsRunning(StatusEvent e) => StatusIsRunning?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusInNoFireZoneEvent;

        internal void InvokeStatusInNoFireZone(StatusEvent e) => StatusInNoFireZoneEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusDockedEvent;

        internal void InvokeStatusDocked(StatusEvent e) => StatusDockedEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusLandedEvent;

        internal void InvokeStatusLanded(StatusEvent e) => StatusLandedEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusFsdCooldownEvent;

        internal void InvokeStatusFsdCooldown(StatusEvent e) => StatusFsdCooldownEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusGearEvent;

        internal void InvokeStatusGear(StatusEvent e) => StatusGearEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusShieldsEvent;

        internal void InvokeStatusShields(StatusEvent e) => StatusShieldsEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusSupercruiseEvent;

        internal void InvokeStatusSupercruise(StatusEvent e) => StatusSupercruiseEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusFlightAssistEvent;

        internal void InvokeStatusFlightAssist(StatusEvent e) => StatusFlightAssistEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusHardpointsEvent;

        internal void InvokeStatusHardpoints(StatusEvent e) => StatusHardpointsEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusWingingEvent;

        internal void InvokeStatusWinging(StatusEvent e) => StatusWingingEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusLightsEvent;

        internal void InvokeStatusLights(StatusEvent e) => StatusLightsEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusCargoScoopEvent;

        internal void InvokeStatusCargoScoop(StatusEvent e) => StatusCargoScoopEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusSilentRunningEvent;

        internal void InvokeStatusSilentRunning(StatusEvent e) => StatusSilentRunningEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusScoopingEvent;

        internal void InvokeStatusScooping(StatusEvent e) => StatusScoopingEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusSrvHandbreakEvent;

        internal void InvokeStatusSrvHandbreak(StatusEvent e) => StatusSrvHandbreakEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusSrvTurrentEvent;

        internal void InvokeStatusSrvTurrent(StatusEvent e) => StatusSrvTurrentEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusSrvNearShipEvent;

        internal void InvokeStatusSrvNearShip(StatusEvent e) => StatusSrvNearShipEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusSrvDriveAssistEvent;

        internal void InvokeStatusSrvDriveAssist(StatusEvent e) => StatusSrvDriveAssistEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusMassLockedEvent;

        internal void InvokeStatusMassLocked(StatusEvent e) => StatusMassLockedEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusFsdChargingEvent;

        internal void InvokeStatusFsdCharging(StatusEvent e) => StatusFsdChargingEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusFsdCooldowEvent;

        internal void InvokeStatusFsdCooldow(StatusEvent e) => StatusFsdCooldowEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusLowFuelEvent;

        internal void InvokeStatusLowFuel(StatusEvent e) => StatusLowFuelEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusOverheatingEvent;

        internal void InvokeStatusOverheating(StatusEvent e) => StatusOverheatingEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusHasLatLongEvent;

        internal void InvokeStatusHasLatLong(StatusEvent e) => StatusHasLatLongEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusInDangerEvent;

        internal void InvokeStatusInDanger(StatusEvent e) => StatusInDangerEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusInInterdictionEvent;

        internal void InvokeStatusInInterdiction(StatusEvent e) => StatusInInterdictionEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusInMothershipEvent;

        internal void InvokeStatusInMothership(StatusEvent e) => StatusInMothershipEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusInFighterEvent;

        internal void InvokeStatusInFighter(StatusEvent e) => StatusInFighterEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusInSRVEvent;

        internal void InvokeStatusInSRV(StatusEvent e) => StatusInSRVEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusAnalysisModeEvent;

        internal void InvokeStatusAnalysisMode(StatusEvent e) => StatusAnalysisModeEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusNightVisionEvent;

        internal void InvokeStatusNightVision(StatusEvent e) => StatusNightVisionEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusAltitudeFromRadiusEvent;

        internal void InvokeStatusAltitudeFromRadius(StatusEvent e) => StatusAltitudeFromRadiusEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusFsdJumpEvent;

        internal void InvokeStatusFsdJump(StatusEvent e) => StatusFsdJumpEvent?.Invoke(this, e);

        public event EventHandler<StatusEvent> StatusSrvHighBeamEvent;

        internal void InvokeStatusSrvHighBeam(StatusEvent e) => StatusSrvHighBeamEvent?.Invoke(this, e);
