...
namespace EliteAPI.Status.Processor.Abstractions
{
    ...
    public interface IStatusProcessor
    {
        ...
        /// <summary>
        /// Hooks the specified status file to <see cref="StatusUpdated"/> and invokes <see cref="StatusUpdated"/> when needed
        /// </summary>
        ...
        /// <summary>
        /// Hooks the specified market file to <see cref="MarketUpdated"/> and invokes <see cref="MarketUpdated"/> when needed
        /// </summary>
        Task ProcessMarketFile(FileInfo marketFile);

        /// <summary>
        /// Hooks the specified shipyard file to <see cref="ShipyardUpdated"/> and invokes <see cref="ShipyardUpdated"/> when needed
        /// </summary>
        Task ProcessShipyardFile(FileInfo shipyardFile);

        /// <summary>
        /// Hooks the specified outfitting file to <see cref="OutfittingUpdated"/> and invokes <see cref="OutfittingUpdated"/> when needed
        /// </summary>
