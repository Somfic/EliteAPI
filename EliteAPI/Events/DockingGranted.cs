namespace EliteAPI.Events
{
    ...
    public partial class DockingGrantedInfo
    {
        public static DockingGrantedInfo Process(string json) => EventHandler.InvokeDockingGrantedEvent(JsonConvert.DeserializeObject<DockingGrantedInfo>(json, EliteAPI.Events.DockingGrantedConverter.Settings));
    }
