namespace EliteAPI.Events
{
    ...
    public partial class ShieldStateInfo
    {
        public static ShieldStateInfo Process(string json) => EventHandler.InvokeShieldStateEvent(JsonConvert.DeserializeObject<ShieldStateInfo>(json, EliteAPI.Events.ShieldStateConverter.Settings));
    }
