namespace EliteAPI.Events
{
    ...
    public partial class CommunityGoalRewardInfo
    {
        public static CommunityGoalRewardInfo Process(string json) => EventHandler.InvokeCommunityGoalRewardEvent(JsonConvert.DeserializeObject<CommunityGoalRewardInfo>(json, EliteAPI.Events.CommunityGoalRewardConverter.Settings));
    }
