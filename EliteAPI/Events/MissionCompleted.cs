namespace EliteAPI.Events
{
    ...
    public partial class MissionCompletedInfo
    {
        public static MissionCompletedInfo Process(string json) => EventHandler.InvokeMissionCompletedEvent(JsonConvert.DeserializeObject<MissionCompletedInfo>(json, EliteAPI.Events.MissionCompletedConverter.Settings));
    }
