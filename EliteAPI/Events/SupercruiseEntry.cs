namespace EliteAPI.Events
{
    ...
    public partial class SupercruiseEntryInfo
    {
        public static SupercruiseEntryInfo Process(string json) => EventHandler.InvokeSupercruiseEntryEvent(JsonConvert.DeserializeObject<SupercruiseEntryInfo>(json, EliteAPI.Events.SupercruiseEntryConverter.Settings));
    }
