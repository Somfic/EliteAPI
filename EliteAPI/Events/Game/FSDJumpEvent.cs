...
public readonly struct FsdJumpEvent : IEvent
{
    ...
    public LocalisedField SystemEconomy { get; init; }

    [JsonProperty("SystemSecondEconomy")]
    public LocalisedField SystemSecondEconomy { get; init; }

    [JsonProperty("SystemGovernment")]
    public LocalisedField SystemGovernment { get; init; }

    [JsonProperty("SystemSecurity")]
    public LocalisedField SystemSecurity { get; init; }
    ...
    public readonly struct FactionInfo
    {
        ...
        public LocalisedField Happiness { get; init; }
