namespace EliteAPI.Events
{
    ...
    public partial class PromotionInfo
    {
        public static PromotionInfo Process(string json) => EventHandler.InvokePromotionEvent(JsonConvert.DeserializeObject<PromotionInfo>(json, EliteAPI.Events.PromotionConverter.Settings));
    }
