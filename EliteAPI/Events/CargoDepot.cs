namespace EliteAPI.Events
{
    ...
    public partial class CargoDepotInfo
    {
        public static CargoDepotInfo Process(string json) => EventHandler.InvokeCargoDepotEvent(JsonConvert.DeserializeObject<CargoDepotInfo>(json, EliteAPI.Events.CargoDepotConverter.Settings));
    }
