namespace EliteAPI.Events
{
    ...
    public partial class PassengersInfo
    {
        public static PassengersInfo Process(string json) => EventHandler.InvokePassengersEvent(JsonConvert.DeserializeObject<PassengersInfo>(json, EliteAPI.Events.PassengersConverter.Settings));
    }
