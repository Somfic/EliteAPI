namespace EliteAPI.Events
{
    ...
    public partial class PVPKillInfo
    {
        public static PVPKillInfo Process(string json) => EventHandler.InvokePVPKillEvent(JsonConvert.DeserializeObject<PVPKillInfo>(json, EliteAPI.Events.PVPKillConverter.Settings));
    }
