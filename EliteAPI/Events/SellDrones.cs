namespace EliteAPI.Events
{
    ...
    public partial class SellDronesInfo
    {
        public static SellDronesInfo Process(string json) => EventHandler.InvokeSellDronesEvent(JsonConvert.DeserializeObject<SellDronesInfo>(json, EliteAPI.Events.SellDronesConverter.Settings));
    }
