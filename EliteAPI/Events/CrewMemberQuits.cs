namespace EliteAPI.Events
{
    ...
    public partial class CrewMemberQuitsInfo
    {
        public static CrewMemberQuitsInfo Process(string json) => EventHandler.InvokeCrewMemberQuitsEvent(JsonConvert.DeserializeObject<CrewMemberQuitsInfo>(json, EliteAPI.Events.CrewMemberQuitsConverter.Settings));
    }
