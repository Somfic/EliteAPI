namespace EliteAPI.Events
{
    ...
    public partial class FSSDiscoveryScanInfo
    {
        public static FSSDiscoveryScanInfo Process(string json) => EventHandler.InvokeFSSDiscoveryScanEvent(JsonConvert.DeserializeObject<FSSDiscoveryScanInfo>(json, EliteAPI.Events.FSSDiscoveryScanConverter.Settings));
    }
