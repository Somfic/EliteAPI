namespace EliteAPI.Events
{
    ...
    public partial class HeatDamageInfo
    {
        public static HeatDamageInfo Process(string json) => EventHandler.InvokeHeatDamageEvent(JsonConvert.DeserializeObject<HeatDamageInfo>(json, EliteAPI.Events.HeatDamageConverter.Settings));
    }
