namespace EliteAPI.Events
{
    ...
    public partial class ShipyardInfo
    {
        public static ShipyardInfo Process(string json) => EventHandler.InvokeShipyardEvent(JsonConvert.DeserializeObject<ShipyardInfo>(json, EliteAPI.Events.ShipyardConverter.Settings));
    }
