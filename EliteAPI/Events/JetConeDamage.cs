namespace EliteAPI.Events
{
    ...
    public partial class JetConeDamageInfo
    {
        public static JetConeDamageInfo Process(string json) => EventHandler.InvokeJetConeDamageEvent(JsonConvert.DeserializeObject<JetConeDamageInfo>(json, EliteAPI.Events.JetConeDamageConverter.Settings));
    }
