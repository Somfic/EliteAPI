...
namespace EliteAPI.EDDN.Schemas.fssdiscoveryscan_v1_0
{
    ...
    public partial class Message
    {
        ...
        public Disallowed Progress { get; set; }

        [Newtonsoft.Json.JsonProperty("BodyCount", Required = Newtonsoft.Json.Required.Always)]
        public int BodyCount { get; set; }

        [Newtonsoft.Json.JsonProperty("NonBodyCount", Required = Newtonsoft.Json.Required.Always)]
    ...
    public enum MessageEvent
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"FSSDiscoveryScan")]
        FSSDiscoveryScan = 0,
