namespace EliteAPI.Events
{
    ...
    public partial class AppliedToSquadronInfo
    {
        public static AppliedToSquadronInfo Process(string json) => EventHandler.InvokeAppliedToSquadronEvent(JsonConvert.DeserializeObject<AppliedToSquadronInfo>(json, EliteAPI.Events.AppliedToSquadronConverter.Settings));
    }
