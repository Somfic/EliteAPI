namespace EliteAPI.Events
{
    ...
    public partial class ModuleSwapInfo
    {
        public static ModuleSwapInfo Process(string json) => EventHandler.InvokeModuleSwapEvent(JsonConvert.DeserializeObject<ModuleSwapInfo>(json, EliteAPI.Events.ModuleSwapConverter.Settings));
    }
