namespace EliteAPI.Events
{
    ...
    public partial class LiftoffInfo
    {
        public static LiftoffInfo Process(string json) => EventHandler.InvokeLiftoffEvent(JsonConvert.DeserializeObject<LiftoffInfo>(json, EliteAPI.Events.LiftoffConverter.Settings));
    }
