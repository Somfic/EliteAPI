namespace EliteAPI.Events
{
    ...
    public partial class CargoInfo
    {
        public static CargoInfo Process(string json) => EventHandler.InvokeCargoEvent(JsonConvert.DeserializeObject<CargoInfo>(json, EliteAPI.Events.CargoConverter.Settings));
    }
