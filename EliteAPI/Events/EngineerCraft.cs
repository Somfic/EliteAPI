namespace EliteAPI.Events
{
    ...
    public partial class EngineerCraftInfo
    {
        public static EngineerCraftInfo Process(string json) => EventHandler.InvokeEngineerCraftEvent(JsonConvert.DeserializeObject<EngineerCraftInfo>(json, EliteAPI.Events.EngineerCraftConverter.Settings));
    }
