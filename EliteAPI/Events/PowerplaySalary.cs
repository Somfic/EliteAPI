namespace EliteAPI.Events
{
    ...
    public partial class PowerplaySalaryInfo
    {
        public static PowerplaySalaryInfo Process(string json) => EventHandler.InvokePowerplaySalaryEvent(JsonConvert.DeserializeObject<PowerplaySalaryInfo>(json, EliteAPI.Events.PowerplaySalaryConverter.Settings));
    }
