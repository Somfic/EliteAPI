...
namespace EliteAPI.EDDN.Schemas.scanbarycentre_v1_0
{
    ...
    public partial class Message
    {
        ...
        [Newtonsoft.Json.JsonProperty("SemiMajorAxis", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double SemiMajorAxis { get; set; }

        [Newtonsoft.Json.JsonProperty("Eccentricity", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double Eccentricity { get; set; }

        [Newtonsoft.Json.JsonProperty("OrbitalInclination", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double OrbitalInclination { get; set; }

        [Newtonsoft.Json.JsonProperty("Periapsis", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double Periapsis { get; set; }

        [Newtonsoft.Json.JsonProperty("OrbitalPeriod", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double OrbitalPeriod { get; set; }

        [Newtonsoft.Json.JsonProperty("AscendingNode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double AscendingNode { get; set; }

        [Newtonsoft.Json.JsonProperty("MeanAnomaly", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public enum MessageEvent
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"ScanBaryCentre")]
        ScanBaryCentre = 0,
