namespace EliteAPI.Events
{
    ...
    public partial class ModuleSellInfo
    {
        public static ModuleSellInfo Process(string json) => EventHandler.InvokeModuleSellEvent(JsonConvert.DeserializeObject<ModuleSellInfo>(json, EliteAPI.Events.ModuleSellConverter.Settings));
    }
