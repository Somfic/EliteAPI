namespace EliteAPI.Events
{
    ...
    public partial class TechnologyBrokerInfo
    {
        public static TechnologyBrokerInfo Process(string json) => EventHandler.InvokeTechnologyBrokerEvent(JsonConvert.DeserializeObject<TechnologyBrokerInfo>(json, EliteAPI.Events.TechnologyBrokerConverter.Settings));
    }
