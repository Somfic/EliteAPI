namespace EliteAPI.Events
{
    ...
    public partial class CockpitBreachedInfo
    {
        public static CockpitBreachedInfo Process(string json) => EventHandler.InvokeCockpitBreachedEvent(JsonConvert.DeserializeObject<CockpitBreachedInfo>(json, EliteAPI.Events.CockpitBreachedConverter.Settings));
    }
