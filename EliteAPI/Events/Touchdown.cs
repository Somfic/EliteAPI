namespace EliteAPI.Events
{
    ...
    public partial class TouchdownInfo
    {
        public static TouchdownInfo Process(string json) => EventHandler.InvokeTouchdownEvent(JsonConvert.DeserializeObject<TouchdownInfo>(json, EliteAPI.Events.TouchdownConverter.Settings));
    }
