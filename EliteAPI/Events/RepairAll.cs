namespace EliteAPI.Events
{
    ...
    public partial class RepairAllInfo
    {
        public static RepairAllInfo Process(string json) => EventHandler.InvokeRepairAllEvent(JsonConvert.DeserializeObject<RepairAllInfo>(json, EliteAPI.Events.RepairAllConverter.Settings));
    }
