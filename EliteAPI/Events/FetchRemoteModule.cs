namespace EliteAPI.Events
{
    ...
    public partial class FetchRemoteModuleInfo
    {
        public static FetchRemoteModuleInfo Process(string json) => EventHandler.InvokeFetchRemoteModuleEvent(JsonConvert.DeserializeObject<FetchRemoteModuleInfo>(json, EliteAPI.Events.FetchRemoteModuleConverter.Settings));
    }
