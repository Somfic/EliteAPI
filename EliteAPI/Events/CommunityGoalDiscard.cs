namespace EliteAPI.Events
{
    ...
    public partial class CommunityGoalDiscardInfo
    {
        public static CommunityGoalDiscardInfo Process(string json) => EventHandler.InvokeCommunityGoalDiscardEvent(JsonConvert.DeserializeObject<CommunityGoalDiscardInfo>(json, EliteAPI.Events.CommunityGoalDiscardConverter.Settings));
    }
