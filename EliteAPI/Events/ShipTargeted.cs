namespace EliteAPI.Events
{
    ...
    public partial class ShipTargetedInfo
    {
        public static ShipTargetedInfo Process(string json) => EventHandler.InvokeShipTargetedEvent(JsonConvert.DeserializeObject<ShipTargetedInfo>(json, EliteAPI.Events.ShipTargetedConverter.Settings));
    }
