namespace EliteAPI.Events
{
    ...
    public partial class ShipyardNewInfo
    {
        public static ShipyardNewInfo Process(string json) => EventHandler.InvokeShipyardNewEvent(JsonConvert.DeserializeObject<ShipyardNewInfo>(json, EliteAPI.Events.ShipyardNewConverter.Settings));
    }
