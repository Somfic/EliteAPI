{"tags":["ModuleStoreInfo","EliteAPI","Events","MarketId","Slot","StoredItem","StoredItemLocalised","Ship","ShipId","Hot","EngineerModifications","Level","Quality","Timestamp","Event"],"status":1}
