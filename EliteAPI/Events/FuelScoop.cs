namespace EliteAPI.Events
{
    ...
    public partial class FuelScoopInfo
    {
        public static FuelScoopInfo Process(string json) => EventHandler.InvokeFuelScoopEvent(JsonConvert.DeserializeObject<FuelScoopInfo>(json, EliteAPI.Events.FuelScoopConverter.Settings));
    }
