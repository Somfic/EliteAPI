namespace EliteAPI.Events
{
    ...
    public partial class RedeemVoucherInfo
    {
        public static RedeemVoucherInfo Process(string json) => EventHandler.InvokeRedeemVoucherEvent(JsonConvert.DeserializeObject<RedeemVoucherInfo>(json, EliteAPI.Events.RedeemVoucherConverter.Settings));
    }
