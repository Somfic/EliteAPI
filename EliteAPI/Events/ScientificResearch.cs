namespace EliteAPI.Events
{
    ...
    public partial class ScientificResearchInfo
    {
        public static ScientificResearchInfo Process(string json) => EventHandler.InvokeScientificResearchEvent(JsonConvert.DeserializeObject<ScientificResearchInfo>(json, EliteAPI.Events.ScientificResearchConverter.Settings));
    }
