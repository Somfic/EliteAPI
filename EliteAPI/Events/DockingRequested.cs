namespace EliteAPI.Events
{
    ...
    public partial class DockingRequestedInfo
    {
        public static DockingRequestedInfo Process(string json) => EventHandler.InvokeDockingRequestedEvent(JsonConvert.DeserializeObject<DockingRequestedInfo>(json, EliteAPI.Events.DockingRequestedConverter.Settings));
    }
