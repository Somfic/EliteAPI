...
namespace EliteAPI.Event.Models
{
    ...
    public class EmbarkEvent : EventBase<EmbarkEvent>
    {
        internal EmbarkEvent() { }
...
namespace EliteAPI.Event.Handler
{
    ...
    {
        public event EventHandler<EmbarkEvent> EmbarkEvent;

        internal void InvokeEmbarkEvent(EmbarkEvent arg)
        {
            EmbarkEvent?.Invoke(this, arg);
        }
    }
}