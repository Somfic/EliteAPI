namespace EliteAPI.Events
{
    ...
    public partial class LeaveBodyInfo
    {
        public static LeaveBodyInfo Process(string json) => EventHandler.InvokeLeaveBodyEvent(JsonConvert.DeserializeObject<LeaveBodyInfo>(json, EliteAPI.Events.LeaveBodyConverter.Settings));
    }
