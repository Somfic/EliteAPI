namespace EliteAPI.Events
{
    ...
    public partial class ModuleRetrieveInfo
    {
        public static ModuleRetrieveInfo Process(string json) => EventHandler.InvokeModuleRetrieveEvent(JsonConvert.DeserializeObject<ModuleRetrieveInfo>(json, EliteAPI.Events.ModuleRetrieveConverter.Settings));
    }
