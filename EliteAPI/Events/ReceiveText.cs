namespace EliteAPI.Events
{
    ...
    public partial class ReceiveTextInfo
    {
        public static ReceiveTextInfo Process(string json) => EventHandler.InvokeReceiveTextEvent(JsonConvert.DeserializeObject<ReceiveTextInfo>(json, EliteAPI.Events.ReceiveTextConverter.Settings));
    }
