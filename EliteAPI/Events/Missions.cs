namespace EliteAPI.Events
{
    ...
    public partial class MissionsInfo
    {
        public static MissionsInfo Process(string json) => EventHandler.InvokeMissionsEvent(JsonConvert.DeserializeObject<MissionsInfo>(json, EliteAPI.Events.MissionsConverter.Settings));
    }
