namespace EliteAPI.Events
{
    ...
    public partial class CrewFireInfo
    {
        public static CrewFireInfo Process(string json) => EventHandler.InvokeCrewFireEvent(JsonConvert.DeserializeObject<CrewFireInfo>(json, EliteAPI.Events.CrewFireConverter.Settings));
    }
